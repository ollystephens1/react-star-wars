    ...
    <div className="col-md-4 mb-4 text-warning">
      <div className="card bg-dark">
        ...
        <ul className="list-group list-group-flush">
          ...
          <li className="list-group-item bg-dark"><b>Hyperdrive</b><span className="text-capitalize float-right small">{props.hyperdrive_rating}</span></li>
          ...
          <li className="list-group-item bg-dark"><b>Class</b><span className="text-capitalize float-right small">{props.starship_class}</span></li>
        </ul>
      </div>
    </div>
  );
